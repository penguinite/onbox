...
#
# strutils.nim:
## This module provides procedures and functions for working with strings.
## These procedures & functions are maybe faster than what std/strutils currently provides.
## Note: The string handling procedures used to be in lib.nim but we want to keep
## that module as lightweight as possible so we moved it!

# TODO: Finish this

from lib import whitespace
