...
-- These were extracted from db/sqlite.nim  
CREATE TABLE IF NOT EXISTS posts (id BLOB PRIMARY KEY UNIQUE NOT NULL,contexts VARCHAR(65535),recipients VARCHAR(65535), sender VARCHAR(65535) NOT NULL, replyto VARCHAR(65535), content VARCHAR(65535) NOT NULL,written TIMESTAMP NOT NULL, updated TIMESTAMP, local BOOLEAN NOT NULL );
CREATE TABLE IF NOT EXISTS users (id BLOB PRIMARY KEY UNIQUE NOT NULL,handle VARCHAR(65535) UNIQUE NOT NULL,name VARCHAR(65535) NOT NULL,local BOOLEAN NOT NULL, email VARCHAR(255),bio VARCHAR(65535),password VARCHAR(65535), salt VARCHAR(65535), is_frozen BOOLEAN);
